...
case class FDef(name: String, params: List[Expr], body: Expr) extends Definition
case class GDef(name: String, pat: Pattern, params: List[Expr], body: Expr) extends Definition
